...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form method="post" class="d-flex" action="/admin/usuarios">
                    <div class="col-sm-5">
    ...
    <main class="row d-flex justify-content-center mt-4">
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="/admin/usuario/nuevo" class="btn btn-lg btn-secondary fw-bold border-white">Crear nuevo usuario</a>
        </div>
        ...
        <table class="table table-dark table-striped">
            ...
            <tr>
                ...
                <td><a href="/admin/usuario/<%= usuario.getId() %>/editar" class="btn btn-primary">
                ...
                <td>
                    ...
                    <a href="/admin/usuario/<%= usuario.getId() %>/borrar" class="btn btn-danger">
