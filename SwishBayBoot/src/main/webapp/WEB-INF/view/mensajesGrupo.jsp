...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    %>
        <div class="d-flex justify-content-between">
            ...
            <a href="MensajeNuevoEditarServlet/<%=idGrupo%>" class="btn btn-lg btn-secondary fw-bold border-white">Crear nuevo mensaje</a>
        </div>
        ...
        <table class="table table-dark table-striped">
            ...
            <tr>
                ...
                <td><a href="MensajeNuevoEditarServlet/<%= mensaje.getId() %>/<%= idGrupo %>" class="btn btn-primary">
                ...
                <td>
                    <a href="MensajeBorrarServlet/<%= mensaje.getId() %>/<%= idGrupo %>" class="btn btn-danger">
