...
<html lang="en">
    ...
    <body class="d-flex h-100 text-center text-white bg-dark">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            %>  
                        <a href="/puja/editar/<%=producto.getId() %>" class="btn btn-primary col-5 " style="width: 100px"> <%= producto.getEnPuja()==0 ?  "Crear puja" : "Ver puja" %></a>
                        <a href="/producto/editar/<%=producto.getId() %>" class="btn btn-primary col-4 mx-2">Modificar</a>
                        <a href="/producto/borrar/<%=producto.getId() %>" class="btn btn-danger col-2">
