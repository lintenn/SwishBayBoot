...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="grupos">Panel de grupos</a>
                    </li>
    ...
    <main class="row d-flex justify-content-center mt-4">
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="crearEditarGrupo" class="btn btn-lg btn-secondary fw-bold border-white">Crear nuevo grupo</a>
        </div>
        ...
        <table class="table table-dark table-striped">
            ...
            <tr>
                ...
                <td><a href="crearEditarGrupo/<%= grupo.getId() %>" class="btn btn-primary">
                ...
                <td>
                    <a href="borrarGrupo/<%= grupo.getId() %>" class="btn btn-danger">
                ...
                <td>
                    <a href="verMensajes/<%= grupo.getId() %>" class="btn btn-success">
