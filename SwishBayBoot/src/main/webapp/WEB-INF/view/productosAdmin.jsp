    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form method="post" class="d-flex" action="/admin/productosAdmin">
                    <%
            ...
            <div class="col-sm-12 mt-0">
                <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center pb-2 px-0">
                        ...
                        <% }
                        %>
                        <a href="/admin/productoAdmin/<%=producto.getId() %>/editar" class="btn btn-primary col-4 mx-2">Modificar</a>
                        <a href="/admin/productoAdmin/<%=producto.getId() %>/borrar" class="btn btn-danger col-2">
